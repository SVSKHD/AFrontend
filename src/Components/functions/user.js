...
export const SaveUserDetails = async (authtoken, address, phone) =>
  await axios.post(
    `${process.env.REACT_APP_API}/user/savedetails`,
    { address, phone },
    {
      headers: {
        authtoken,
...
export const AllUserList = async () =>
  await axios.get(`${process.env.REACT_APP_API}/users/alldata`);
